...
A venda de açaí é um mercado em crescimento e com forte apelo regional.
 ...
 A ideia do Açaí Digital surgiu da necessidade de modernizar o atendimento e facilitar pedidos em horários de pico, evitando filas e erros manuais.
...
├── pedidos.html            → Tela de cadastro/pedidos


├── carrinho.html           → Tela do carrinho


├── tradicionais.html       → (opcional) Página de produtos tradicionais


│
├── style.css               → Estilos globais (home + pedidos + carrinho)
...
│   ├── home-tradicionais.jpg


│   ├── home-barcas.jpg


│   ├── queridinho-cookies.jpg


│   ├── queridinho-pistache.jpg


│   ├── queridinho-sensacao.jpg


│   ├── queridinho-nutella.jpg
